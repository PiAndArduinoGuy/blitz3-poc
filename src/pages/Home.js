...
export default Blits.Component('Home', {
  ...
  template: `
    <Element w="1920" h="1080" color="{top: '#3295a8', bottom: '#85bec9'}">
		...
		<Element w="400" h="100" x="960" y="650" mount="0.5" color="red">
			<Button w="200" h="50" displayText="Tiles" ref="0" />
			<Button w="200" h="50" displayText="Tiles" ref="1"  :x="$x + 10"/>
			<Button w="200" h="50" displayText="Tiles" ref="2" y="60" />
			<Button w="200" h="50" displayText="Tiles" ref="3"  x="210" y="60" />
		</Element>
